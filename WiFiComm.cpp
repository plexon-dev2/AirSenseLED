...
//     Serial.println("[WiFiComm] Connecting to WiFi...");
...
//     Serial.printf("[WiFiComm] MQTT broker : %s:%d\n",
//                   WIFI_MQTT_BROKER_IP, (int)WIFI_MQTT_BROKER_PORT);
// #endif

//     Serial.println("[WiFiComm] ========== INIT COMPLETE ==========\n");
// }
...
//     {
//         Serial.printf("[WiFiComm] TCP-C TX: %s\n", payload);
...
//     {
//         Serial.printf("[WiFiComm] TCP-S TX: %s\n", payload);
//         return WIFI_STATUS_OK;
//     }
//     return WIFI_STATUS_ERROR;
// #else
...
//     if (result)
//     {
//         Serial.printf("[WiFiComm] MQTT PUB [%s]: %s\n", topic, payload);
//         return WIFI_STATUS_OK;
//     }
//     return WIFI_STATUS_ERROR;
// #else
...
//     /* PubSubClient publish with length for binary safety */
...
//     if (result)
//     {
//         Serial.printf("[WiFiComm] MQTT PUB EX [%s] QoS=%d: %s\n",
...
//     {
//         Serial.printf("[WiFiComm] MQTT SUB: %s\n", topic);
//         return WIFI_STATUS_OK;
//     }
//     return WIFI_STATUS_ERROR;
// #else
...
//     {
//         Serial.printf("[WiFiComm] MQTT UNSUB: %s\n", topic);
//         return WIFI_STATUS_OK;
//     }
//     return WIFI_STATUS_ERROR;
// #else
...
//             {
//                 Serial.println("[WiFiComm] WiFi connect timeout ???????? retrying...");
...
//             if (WiFi.status() != WL_CONNECTED)
//             {
//                 Serial.println("[WiFiComm] WiFi lost ???????? reconnecting...");
//                 s_wifiSMState        = WIFI_SM_RECONNECTING;
//                 s_wifiReconnectTimer = currentTimeMs;
...
//                 else
//                 {
//                     Serial.println("[WiFiComm] Retrying WiFi...");
//                     WiFi.reconnect();
//                 }
//             }
//             break;
...
//     Serial.printf("[WiFiComm] WiFi connected! IP: %s  RSSI: %d dBm\n",
...
//         Serial.printf("[WiFiComm] TCP Server started on port %d\n",
//                       (int)WIFI_TCP_SERVER_PORT);
//     }
// #endif
// }
...
// static void WiFiComm__OnWiFiDisconnected(void)
// {
//     Serial.println("[WiFiComm] WiFi disconnected");
...
//             Serial.printf("[WiFiComm] TCP Client connecting to %s:%d...\n",
//                           WIFI_TCP_CLIENT_SERVER_IP,
//                           (int)WIFI_TCP_CLIENT_PORT);
...
//                 Serial.printf("[WiFiComm] TCP Client connected to %s:%d\n",
//                               WIFI_TCP_CLIENT_SERVER_IP,
//                               (int)WIFI_TCP_CLIENT_PORT);
//             }
//             else
...
//                 Serial.println("[WiFiComm] TCP Client connect failed ???????? retrying...");
//             }
//             break;
//         }
...
//             {
//                 Serial.println("[WiFiComm] TCP Client disconnected ???????? retrying...");
//                 s_tcpClient.stop();
//                 s_tcpClientSMState     = TCP_CLIENT_SM_RECONNECTING;
//                 s_tcpClientReconnTimer = currentTimeMs;
//                 break;
...
//                 Serial.printf("[WiFiComm] TCP-C RX (%d bytes): %s\n",
...
//             Serial.printf("[WiFiComm] TCP Server: client connected from %s\n",
...
//         Serial.printf("[WiFiComm] TCP-S RX (%d bytes): %s\n",
...
//         Serial.printf("[WiFiComm] MQTT connecting to %s:%d as '%s'...\n",
//                       WIFI_MQTT_BROKER_IP,
//                       (int)WIFI_MQTT_BROKER_PORT,
//                       WIFI_MQTT_CLIENT_ID);
...
//         {
//             Serial.println("[WiFiComm] MQTT connected!");

//             /* Re-subscribe to command topic after reconnect */
//             s_mqttClient.subscribe(WIFI_MQTT_TOPIC_COMMAND,
//                                     (int)WIFI_MQTT_QOS);
//             Serial.printf("[WiFiComm] MQTT subscribed: %s\n",
//                           WIFI_MQTT_TOPIC_COMMAND);
//         }
//         else
//         {
//             Serial.printf("[WiFiComm] MQTT connect failed. State: %d\n",
//                           s_mqttClient.state());
//         }
//     }
// #else
...
//     Serial.printf("[WiFiComm] MQTT RX [%s]: %s\n",
...
#include <WiFiClient.h>
#include <WiFiServer.h>
#include <esp_wifi.h>          /* BLE+WiFi coexistence, power save control */
#include "WiFiComm.h"
#include "WiFiComm_Cfg.h"
#include "AQ_LEDHMI.h"
 ...
 * @details When disabled, eliminates Serial contention with Modbus RX on Core 0
 */
#define WIFICOMM_DEBUG_ENABLE  (1U)

#if (WIFICOMM_DEBUG_ENABLE == 1U)
  #define WIFI_DBG_PRINTF(...)   Serial.printf(__VA_ARGS__)
  #define WIFI_DBG_PRINTLN(...)  Serial.println(__VA_ARGS__)
#else
  #define WIFI_DBG_PRINTF(...)   /* Disabled */
  #define WIFI_DBG_PRINTLN(...)  /* Disabled */
#endif
...
{
    Preferences prefs;
    WIFI_DBG_PRINTLN("[WiFiComm] Clearing NVS credentials - rebooting...");
